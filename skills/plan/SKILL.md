...
Plan implementation work for an implementer who starts with very little context about the codebase or problem domain. Shape the execution strategy into clear, reliable, and verifiable steps, then save the plan as a durable handoff artifact under `plans/`.
