...
reliable, and verifiable steps, then save the plan as a durable handoff
...
**Source of Truth:** [Approved spec, issue, user request, or other basis for this plan]
...
Review every plan before handoff to ensure the scope, task order,
verification, and references are clear and reliable.

For smaller or straightforward tasks, a direct self-review is sufficient.

For larger, riskier, or more ambiguous tasks, dispatch a plan reviewer
subagent using `references/plan-reviewer-prompt.md`. If issues are found,
revise the plan and re-dispatch until approved.
