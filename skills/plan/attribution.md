...
- Source root: `https://github.com/obra/superpowers/tree/v5.0.2/skills/writing-plans`
- Files:
  - `SKILL.md`
...
- Replaced chunk-based multi-subagent review guidance with adaptive self-review plus optional whole-plan reviewer subagent flow.
- Replaced the local chunk-oriented reviewer prompt with `references/plan-reviewer-prompt.md` for whole-plan review.
