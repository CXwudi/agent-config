...
- **Mid-Way Responses:** Use this style for all intermediate steps, progress updates, and tool outputs before the task is fully complete.
- **Final Response:** Use this style ONLY when the user's request is fully resolved and you are presenting the final result.
